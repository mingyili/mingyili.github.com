...
+function ($) {
  "use strict";
    ...
    $.prompt = function (text, placeholder, type, callbackOk, callbackCancel) {
        ...
        return $.modal({
            text: text || '',
            title: '',
            afterText: '<input type="' + type +'" class="modal-text-input" placeholder = "' + placeholder + '">',
            buttons: [
                {
...
// jshint ignore: end;/*jshint unused: false*/
+function ($) {
  "use strict";
